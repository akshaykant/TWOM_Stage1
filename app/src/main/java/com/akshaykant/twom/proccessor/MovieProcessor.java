package com.akshaykant.twom.proccessor;

import android.net.Uri;
import android.os.AsyncTask;
import android.util.Log;

import com.akshaykant.twom.AsyncResponse;
import com.akshaykant.twom.Movie;
 ...
 * Created by Akshay Kant
        */
    public class MovieProcessor extends AsyncTask<String, Void, List<Movie>> {

    public AsyncResponse delegate;
    private final String LOG_TAG = MovieProcessor.class.getSimpleName();
    private final String API_KEY = "b49c3d9a0517e6c4f87b2a1e3447c2f7";
    private final String MOVIE_POSTER_BASE = "http://image.tmdb.org/t/p/";
    private final String MOVIE_POSTER_SIZE = "w185";

    public MovieProcessor(AsyncResponse delegate){
    ...
    private List<Movie> extractData(String moviesJsonStr) throws JSONException {
        ...
        for(int i = 0; i < moviesLength; ++i) {
            ...
            movies.add(new com.akshaykant.twom.Movie(title, poster, overview, voteAverage, releaseDate));
